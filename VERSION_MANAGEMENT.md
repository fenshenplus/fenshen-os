...
> 当前版本：**v5.4**（`0.54.0` / release `v5.4`，**2026-08-12 已签字**）
> 基于：`v4.1`（git `f5b1929`）
> 分支：`fix/v4.0-audit`
> 最后更新：2026-08-10
