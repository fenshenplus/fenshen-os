...
> 产品：分身 · 元神（你的数字分身）驾驶 WorkBuddy（执行外壳）；群聊已降级为功能，非主形态
> 工作区：`/Users/a13401098230/WorkBuddy/fenshen-v1/`
> 当前版本：**v6.4**（`0.64.43` / release `v6.4`；元神人格蒸馏 9 维 + 访谈题库 291 题 + 资料蒸馏 10 类素材 + 原生标准库 + 187 个 API 端点）
> 基于：`v4.1`（git `f5b1929`）
> 分支：`fix/v4.0-audit`
> 最后更新：2026-09-03（v6.1 已发布：8002 切换新二进制 · git tag `v6.1` · dmg 已生成 · S4 官网推送待网络恢复）
