...
> 当前版本：**v5.3**（`0.53.0` / release `v5.3`，**2026-08-12 已签字**）
> 基于：`v4.1`（git `f5b1929`）
> 分支：`fix/v4.0-audit`
> 最后更新：2026-08-10
